...
float Emf[9]  = {radians(-20), radians(-15), radians(-10), radians(0), radians(10), radians(15), radians(20)};
float DEmf[9] = {radians(-10), radians(-5), radians(-2), radians(0), radians(2), radians(5), radians(10)};
